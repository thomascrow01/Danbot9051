...
async def on_message(message):
    ...
    m = str(message).lower()      
    prefix = '&'
    if message.content == ('hey dan'):
        msg = 'yeah?'.format(message)
        await client.send_message(message.channel, msg)
        
    if message.content == ('hi dan'):
    ...
    if message.content == ('thanks dan'):
        msg = "s'ok".format(message)
        await client.send_message(message.channel, msg)
    ...
    if message.content.startswith('harry wallace help'):
        msg = 'yeah what'.format(message)
        await client.send_message(message.channel, msg)
